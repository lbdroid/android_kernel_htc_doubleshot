...
struct mt9d015_reg {
	struct mt9d015_i2c_reg_conf *power_up_tbl;
	uint16_t power_up_tbl_size;
	struct mt9d015_i2c_reg_conf *register_init_1;
	uint16_t register_init_size_1;
	struct mt9d015_i2c_reg_conf *register_init_2;
	uint16_t register_init_size_2;
	struct mt9d015_i2c_reg_conf *contract_tb0;
	uint16_t contract_tb0_size;
	struct mt9d015_i2c_reg_conf *contract_tb1;
	uint16_t contract_tb1_size;
	struct mt9d015_i2c_reg_conf *contract_tb2;
	uint16_t contract_tb2_size;
	struct mt9d015_i2c_reg_conf *contract_tb3;
	uint16_t contract_tb3_size;
	struct mt9d015_i2c_reg_conf *contract_tb4;
	uint16_t contract_tb4_size;
	struct mt9d015_i2c_reg_conf *wb_auto;
	uint16_t wb_auto_size;
	struct mt9d015_i2c_reg_conf *wb_fluorescent;
	uint16_t wb_fluorescent_size;
	struct mt9d015_i2c_reg_conf *wb_incandescent;
	uint16_t wb_incandescent_size;
	struct mt9d015_i2c_reg_conf *wb_daylight;
	uint16_t wb_daylight_size;
	struct mt9d015_i2c_reg_conf *wb_cloudy;
